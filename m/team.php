...
?>
            <div class="toptitle11"><span>我的下级</span></div>			
			 <div class="h_invitedagen3">
                    <dl>
                        <dt><span>总人数</span></d> <dd><span><?=$num?>人</span></dd>
                    </dl>
			</div>			
			 <div class="h_invitedagen3"  style="display:none">
                    <dl>
                        <dt><span>总收益</span></dt> <dd><span>0元</span></dd>
                    </dl>
			</div>
...
{$tc=$site_morenticheng;} 
            ...
            <dl>
                        ...
                        <dt><span><?=$row['username']?></span></dt> 
                        <dt><span><?=$dsnum?></span></dt> 
                        <dt><span><?=$tc?>%</span></dt> 
                      </dl>
<? }?>
