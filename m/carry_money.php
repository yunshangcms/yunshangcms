        ...
        <section id="container">
            <!--mid0-->
             <div class="h_invitedagent1">
                    <dl>
                        ...
                        <dt><span>手续费</span></dt>
                        <dt><span>实际到账</span></dt>
                        <dt><span>收款方式</span></dt>
                        <dt><span>收款账号</span></dt>
                        <dt><span>收款姓名</span></dt>
                        <dt><span>提现时间</span></dt>
                        <dt><span>状态</span></dt>
                    </dl>
            </div>
            ...
            <?
						 ...
						 {$type='<font color="red">拒绝</font>';}  
									...
									?>
            <dl>
                        <dt><span>￥<?=$row['rmb']?></span></dt> 
                        <dt><span>￥<?=$row['sxf']?></span></dt> 
                        <dt><span>￥<?=($row['rmb']-$row['sxf'])?></span></dt> 
                        <dt><span><?=$row['shoukuanfs']?></span></dt> 
                        <dt><span><?=$row['shoukuanxm']?></span></dt> 
                        <dt><span><?=$row['shoukuanzh']?></span></dt> 
