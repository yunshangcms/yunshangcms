    ...
    <body class="webbg">
      ...
      <div class="h_home_box">
               <div class="h_ewwmurl_con">
                    <i class="btn2"><a href="hezitgadd.php">添加推广</a></i>
                </div>
</div>
            ...
            <!--mid0-->
             <div class="h_invitedagent1">
                    <dl>
                        <dt><span>ID</span></dt>
                        <dt><span>盒子名称</span></dt>
                        <dt><span>免费视频地址</span></dt>
                        <dt><span>推广链接</span></dt>
                        <dt><span>操作</span></dt>
                      </dl>
            </div>
            ...
            <dl>
                        ...
                        <dt><span><?=$row['url']?></span></dt> 
                        <dt><span><?=$tgurl?></span></dt> 
                        <dt><span>   <a   href="?act=del&id=<?=$row['ID']?>">删除</a></span></dt> 
                       </dl>
<? }?>
