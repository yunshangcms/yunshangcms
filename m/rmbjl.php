    ...
    <body class="webbg">
        <section id="container">
            <!--mid0-->
             <div class="h_invitedagent1">
                    <dl>
                        <dt><span>类型</span></dt>
                        <dt><span>项目</span></dt>
                        <dt><span>消费前金额</span></dt>
                        <dt><span>消费金额</span></dt>
                        <dt><span>消费后金额</span></dt>
                         <dt><span>时间</span></dt>
                     </dl>
            </div>
            ...
            <dl>
                        ...
                        <dt><span>￥<?=$row['qje']?></span></dt> 
                        <dt><span>￥<?=$row['je']?></span></dt> 
                        <dt><span>$<?=$row['hje']?></span></dt> 
