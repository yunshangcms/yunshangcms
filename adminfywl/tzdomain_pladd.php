...
$array=explode("\n", $array); 
 foreach($array as $v){
   ...
   for ($i = 0; $i < sizeof($s); $i++) {  
	...
	$sql2 = 'insert into '.flag.'tzurl ('.$str2[0].') values ('.$str2[1].')';
    mysql_query($sql2);	
	
	
  
  }
		alert_href('成功添加跳转域名'.sizeof($s).'条','?');
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span> 批量新增跳转域名</div>
