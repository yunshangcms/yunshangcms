...
if (isset($_POST['提交'])){
	...
	$sql = 'insert into '.flag.'guanliyuan ('.$str[0].') values ('.$str[1].')';
	if (mysql_query($sql)) {
		$order = mysql_insert_id();
	 
		alert_href('管理员添加成功!','guanliyuan.php');
	} else {
		alert_back('添加失败!');
	}
}
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span> 新增管理员</div>
					<div class="panel-body">
						<form class="form-horizontal" action="" method="post">
			                ...
			                <input name="loginname" type="text" class="form-control"  id="" placeholder="请输入登录账号"    >
			                ...
			                <input name="loginpassword" type="text" class="form-control"  id="" placeholder="请输入登录密码"    >
       	  ...
       	  <div class="layui-input-inline"> <input name="qx[]" type="checkbox" value="视频管理">视频管理 </div>
       	  <div class="layui-input-inline"> <input name="qx[]" type="checkbox" value="提现管理">提现管理 </div>
							</div>
								</div>
