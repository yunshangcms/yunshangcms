...
if (isset($_POST['提交'])){
	null_back($_POST['a_name'],'请填写广告名称');
	null_back($_POST['a_url'],'请填写广告地址');
 	$_data['a_name'] = $_POST['a_name'];
	$_data['a_url'] = $_POST['a_url'];
   	$_data['a_pic'] = $_POST['i_pic'];
 
	$str = arrtoinsert($_data);
	$sql = 'update '.flag.'ad set '.arrtoupdate($_data).' where id = '.$_GET['id'].'';
	if (mysql_query($sql)) {
		$order = mysql_insert_id();

		alert_href('广告修改成功!','ad.php');
	} else {
		alert_back('修改失败!');
	}
}
...
<body>
 ...
 <br>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span> 新增广告</div>
					<div class="panel-body">
					
						<?php
					$result = mysql_query('select * from '.flag.'ad where id = '.$_GET['id'].' ');
				...
				<form method="post" name="formrec"   class="form-horizontal"  id="formrec" role="form">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">广告主图</label>
									<div class="col-md-9">
																<input  class="form-control"  placeholder="外链请直接输入图片地址" type="text" name="i_pic" id="i_pic" value="<?=$row['a_pic']?>">
  ...
  <div class="layui-input-inline w450">
					 	...
					 	<div class="form-group">
									<label class="col-md-3 control-label" for="name">广告名称</label>
									<div class="col-md-9">
			                <input name="a_name" type="text"  class="form-control" id="a_name"   placeholder="广告名称"    value="<?=$row['a_name']?>" >
...
.ke-button-common   { height:40PX; margin-top:10px}
								 	...
								 	<div class="form-group">
									<label class="col-md-3 control-label" for="name">广告地址</label>
									<div class="col-md-9">
 
							<input id="a_url"   class="form-control" type="text" name="a_url"  placeholder="外链请直接输入广告地址"   value="<?=$row['a_url']?>">
