...
if (isset($_POST['提交'])){
	null_back($_POST['i_pic'],'请输入图片地址');
 	$_data['image'] = $_POST['i_pic'];
 
	$str = arrtoinsert($_data);
	$sql = 'insert into '.flag.'image ('.$str[0].') values ('.$str[1].')';
	if (mysql_query($sql)) {
		$order = mysql_insert_id();

		alert_href('图片添加成功!','image.php');
	} else {
		alert_back('添加失败!');
	}
}
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span> 新增图片库</div>
				...
				<form method="post" name="formrec"   class="form-horizontal"  id="formrec" role="form">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">图片</label>
									<div class="col-md-9">
