...
if (isset($_POST['提交'])){
	...
	$sql = 'insert into '.flag.'ad ('.$str[0].') values ('.$str[1].')';
	if (mysql_query($sql)) {
		$order = mysql_insert_id();

		alert_href('广告添加成功!','ad.php');
	} else {
		alert_back('添加失败!');
	}
}
 ...
 <br>
  ...
  <div class="layui-input-inline w450">
					 	...
					 	<div class="form-group">
									...
									<div class="col-md-9">
			                <input name="a_name" type="text"  class="form-control" id="a_name"   placeholder="广告名称"   >
...
.ke-button-common   { height:40PX; margin-top:10px}
							...
							<input id="a_url"   class="form-control" type="text" name="a_url"  placeholder="外链请直接输入广告地址"   value="">
