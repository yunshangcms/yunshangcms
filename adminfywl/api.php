...
//配置文件内容
	...
	$config .= '<?php';
	$config .= "\n";
   	$config .= 'define(\'apiurl\', \''.$_POST['url'].'\');';
	$config .= "\n";
    $config .= 'define(\'template\', \''.template.'\');';
	$config .= "\n";	
 	$config .= '?>';
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">检测接口</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
<h1 class="page-header">检测接口</h1>			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span> Api</div>
						...
						<form class="form-horizontal" action="" method="post">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">检测地址</label>
									<div class="col-md-9">
			                <input name="url" type="text"    class="form-control" id="domain" value="<?=apiurl?>" placeholder="请输入检测APi接口，请联系客服购买！">
		</div>
								</div>
