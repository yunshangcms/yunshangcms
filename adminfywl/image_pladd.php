...
$array=explode("\n", $array); 
 foreach($array as $v){
   ...
   for ($i = 0; $i < sizeof($plkey1); $i++) {  
 
  
    $_data2['image'] = $plkey1[$i];
       
   	$str2 = arrtoinsert($_data2);
	$sql2 = 'insert into '.flag.'image ('.$str2[0].') values ('.$str2[1].')';
    mysql_query($sql2);	
	
	
  
  }
		alert_href('成功添加'.sizeof($plkey1).'条','');
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span> 批量新增图片</div>
						...
						<form class="form-horizontal" action="" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
                          <textarea name="content"    class="form-control"   style="height:300PX"  placeholder="格式:图片地址  一行一个" ></textarea> 
							</div>
								</div>
