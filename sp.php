...
{$sid='';}
 ...
 { $payurl='/'.$url.'.php?id='.$_GET['id'].''; $play='<img src="'.$image.'" alt="">';
...
<script type="text/javascript" src="/agency/js/gundong.js"></script>
  ...
  <script>
    var ourl = "/agency/share/pay/vid/33/u/6/j/2056971555233956.html";
  ...
  var _ss = document.body;
    ...
    var getId = (function () {
      ...
      function get_img_data() {
          ...
          var page = getId();
          var purl = "/agency/share/gdata/j/2056971555233956.html";
          var vid = "33";
          var uid = "6";
